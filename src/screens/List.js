...
export default class List extends Component {
  ...
  handleClick = item => {
    ...
    navigate("Room", {
      roomId: item._id // permet de récupérer l'info sous la clé : this.props.navigation.state.params.roomId
    });
  };
    ...
    return (
      <ScrollView style={styles.homeContainer}>
        {/* <View style={styles.homeHeader}>
          <Text style={styles.homeTitle}>MonAirbnb</Text>
        </View> */}
        <FlatList
          keyExtractor={item => {
          ...
          renderItem={({ item }) => (
            // également possible de insérer la boucle dans render
            //             const stars = [];
            //     for (let i = 0; i < 5; i++) {
            //       if (i < value) {
            //         stars.push(
            ...
            >
              ...
              {/* également possible de gérer avec map */}
